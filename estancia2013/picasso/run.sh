...
$SICSTUS -l $SITLOG/src/init --goal start_init. -a -v structlog -m test -d $MESSAGE --save_dir $SAVE $PROJECT $MAIN $InArg $MODELS $KnowledgeBase $SITLOG
